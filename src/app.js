...
$("rules").addEventListener("click", () =>
  info("Como jogar", [
    ...
    "Fotossíntese torna fértil uma casa neutra após duas rodadas completas de permanência. ☀️ Fotossíntese e 🦈 Predação são caminhos evolutivos mutuamente excludentes no mesmo indivíduo, mas a mutação pode trocar de ramo: um descendente fotossintético que adquire Predação perde Fotossíntese; no sentido inverso, adquirir Fotossíntese remove Predação e especializações que exigem esse ramo. A campanha registra ambas como descobertas históricas. Dormência imobiliza a criatura em casa hostil e evita o risco ambiental durante a permanência. Regeneração evita uma morte causada pelo ambiente uma vez por vida e força descanso na rodada seguinte.",
