...
$("rules").addEventListener("click", () =>
  info("Como jogar", [
    ...
    "O relevo natural também faz parte do tabuleiro: quadrados marrons surgem em pequenas cadeias ou afloramentos, com quantidade parcialmente aleatória e própria de cada período geológico. Eles evitam a vizinhança imediata dos fundadores e a geração rejeita configurações que fragmentem excessivamente o mapa. 🐐 Escalador surge opcionalmente no Devoniano após Locomoção e permite ocupar e atravessar barreiras naturais; 🐦 Voo pode atravessá-las, mas não pousar nelas. Meteoros, vulcanismo, terremotos, mares, gelo, rios e chuvas podem criar, derrubar ou erodir parte desse relevo.",
    "⬡ Construção de Nicho neutraliza uma casa hostil estável quando a criatura termina ali e sobrevive. 🦫 Construtor Avançado, liberado no Neógeno após Construção de Nicho, pode erguer uma barreira marrom adjacente depois de uma reprodução bem-sucedida que consumiu uma casa fértil. Barreiras construídas bloqueiam o deslocamento: Voo pode atravessá-las sem destruí-las e Chifre as destrói ao atravessar. Chifre não destrói barreiras naturais; para ocupá-las é necessário 🐐 Escalador. Polegar Opositor pode transferir o terreno fértil ou hostil de chegada para uma casa neutra adjacente; terrenos temporários de eventos, decomposição e barreiras não podem ser manipulados.",
