...
$("rules").addEventListener("click", () =>
  info("Como jogar", [
    ...
    "Em Cenários Alternativos, cada partida completa é um Ciclo Evolutivo: ao fim da extinção, a linhagem dominante e sua melhor contraparte energética fundam a fase seguinte. Em Vida na Terra, a vitória continua registrada na história da partida, mas os fundadores seguintes são definidos pelo período geológico. No Arqueano, o 1º Ciclo estabelece 🟢 Fotossíntese e 🐟 Predação; 💤 Dormência entra na sequência didática. A partir do Ediacarano, os fundadores históricos já expressam 🔵 Respiração aeróbia como metabolismo dominante.",
    ...
    "Linhagens com Fotossíntese não adquirem especializações animais como Locomoção Primitiva, Vertebrado, Artrópode, Locomoção Articulada, Percepção Espacial, Locomoção Avançada, Escavador, Escalador, Respiração Cutânea, Sacos Aéreos, Carnívoro, Canibalismo, Onívoro, Necrófago, Ovíparo, Ovíparos Amniotas, Ovovivíparo, Vivíparo, Ovulação Induzida, Ovífagia, Cuidado Parental, Lactação, Ooteca, Voo, Visão Noturna, Eusocialidade, Chifre, Construtor de Nicho, Polegar Opositor, Neocórtex Desenvolvido ou Antropização. Predação e Fotossíntese permanecem identidades de ramo separadas após a origem primordial; ☯ Mixotrofia fornece capacidades metabólicas complementares sem desbloquear automaticamente especializações do outro ramo. Dormência, Resistência, Regeneração, Reprodução Sexuada, Precocidade Sexual, Carapaça, Camuflagem, Veneno, Coletor e mutações negativas continuam compatíveis com plantas.",
    "🪱 Parasitismo surge opcionalmente no Cambriano no ramo não fotossintético. Selecione a peça e toque nela novamente para gastar a ação: sua casa se torna fértil e cada casa adjacente ocupada por um oponente se torna hostil. Cuidado Parental protege contra Ovífagia enquanto o progenitor estiver vivo e adjacente ao ovo. ꩜ Percepção Espacial habilita o alcance ofensivo remoto normal; Visão Binocular continua sendo a especialização que permite capturar Camuflagem à distância; Visão Noturna neutraliza a evasão de Notívagos em rodadas noturnas. Eusocialidade recebe até +2 descendentes de trabalhadores estéreis aparentados e adjacentes.",
    ...
    "🦗︎ Sociabilidade surge a partir do Jurássico em linhagens que já passaram por Cuidado Parental. Quando uma criatura pertence a um bloco conectado de quatro ou mais peças com Sociabilidade e é atacada, o defensor escolhe qualquer membro desse bloco para ser sacrificado e impedir a captura.",
