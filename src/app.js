...
$("rules").addEventListener("click", () =>
  info("Como jogar", [
    ...
    "Na reprodução sexuada, escolha um aliado adjacente fértil, reprodutivamente apto e do mesmo ramo energético. Fotossintéticos só podem reproduzir sexualmente com fotossintéticos; predatórios, apenas com predatórios. Os descendentes combinam características dos dois progenitores, preservam o ramo energético parental e ambos entram no mesmo período de recuperação reprodutiva. As novas mutações dessa reprodução são positivas.",
