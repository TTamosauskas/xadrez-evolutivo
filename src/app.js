...
$("rules").addEventListener("click", () =>
  info("Como jogar", [
    ...
    "Em Cenários Alternativos, cada partida completa é um Ciclo Evolutivo: ao fim da extinção, a linhagem dominante e sua melhor contraparte energética fundam a fase seguinte. Em Vida na Terra, a vitória continua registrada na história da partida, mas os fundadores seguintes são definidos pelo período geológico. No Arqueano, o 1º Ciclo estabelece 🟢 Fotossíntese e 🐟 Predação; no ciclo seguinte, 🩹 Reparo Celular precede 💤 Dormência e normaliza a estabilidade genética antes da multicelularidade. A partir do Ediacarano, os fundadores históricos já expressam 🔵 Respiração aeróbia como metabolismo dominante.",
    ...
    "Casas verdes geram descendentes e são consumidas. Você pode reproduzir permanecendo sobre uma casa verde. No ramo não fotossintético, Peões geram até 4 descendentes; cavalos, 3; bispos e torres, 2; reis e rainhas, 1. No ramo fotossintético, apenas Reis e Peões são formas evolutivas: Reis geram 1 descendente; Peões geram 3, caindo para 2 quando expressam Traqueófitas, Gimnospermas ou Angiospermas. Cada nascimento tem 1/3 de chance de mutação, inclusive na primeira reprodução. Todo descendente nasce juvenil, aparece menor no tabuleiro e só pode reproduzir após duas rodadas completas. 🪰 Precocidade Sexual reduz essa espera para uma rodada. Depois de uma reprodução bem-sucedida, cada progenitor entra em recuperação por três rodadas; 🐇 Ovulação Induzida reduz esse intervalo para duas.",
    "🐟 Predação é uma mutação basal do Arqueano. Antes de 🔀 Locomoção Primitiva, ela permite apenas capturas que já pertencem à geometria tradicional da peça. No Ediacarano, ⏸ Simetria Bilateral surge após Multicelularismo, dobra a expectativa de vida natural das linhagens animais e prepara os planos corporais; 🔀 Locomoção Primitiva libera deslocamentos para casas vazias usando a geometria oficial da peça. No Cambriano, apenas linhagens bilaterais podem assumir um plano corporal 🐟 Vertebrado ou 🦀 Artrópode, mutuamente exclusivos; qualquer um deles habilita 🦵 Locomoção Articulada. 🐟 Vertebrado libera a progressão completa Peão → Cavalo → Bispo → Torre → Rainha, mantendo Rei disponível. 🦀 Artrópode mantém Peão e Rei e limita as formas derivadas a Cavalo e Bispo, mas dobra a produção-base de descendentes até o teto 6. ꩜ Percepção Espacial surge no Cambriano após Locomoção Articulada e libera capturas além da primeira casa da trajetória oficial da peça; para o Cavalo, o destino do salto é a primeira e única casa da trajetória, então sua captura continua normal sem essa mutação. 🐎 Locomoção Avançada continua permitindo uma segunda movimentação no turno. 🦁 Carnívoro também descende de Predação, reproduz ao capturar e abandona o uso de casas férteis; 🦈 Canibalismo surge no Cambriano após Carnívoro e permite capturar aliados quando o agressor está apto a se reproduzir, convertendo a morte em exatamente um descendente; 🐻 Onívoro surge depois de Carnívoro e recupera também o uso de recursos férteis.",
    ...
    "Em Vida na Terra, mutações positivas só podem aparecer pela primeira vez na janela histórica atribuída a elas. Inovações obrigatórias recebem peso 4×, sucessores diretos de uma característica ancestral recebem 3×, afinidades ecológicas recebem 2× e demais mutações plausíveis recebem 1×. Em Cenários Alternativos, as mutações válidas mantêm peso neutro 1× e respeitam as datas mínimas e dependências atuais. Na Arena, a cronologia é ignorada, mas pré-requisitos e incompatibilidades continuam valendo. Um requisito precisa ter aparecido anteriormente na história daquela linhagem, mas não precisa continuar presente no indivíduo: perdas posteriores preservam o histórico ancestral e não apagam inovações derivadas. Enquanto a próxima inovação obrigatória ainda não apareceu, as anteriores daquela sequência não voltam a surgir como novas mutações, embora continuem sendo herdadas normalmente. No 1º Ciclo, os Reis fundadores ainda não geram Peões por mutação; Rei → Peão entra no pool a partir do 2º Ciclo da campanha. Linhagens não fotossintéticas só evoluem além de Peão e Rei depois de adquirir 🦵 Locomoção Articulada: 🐟 Vertebrados podem seguir Peão → Cavalo → Bispo → Torre → Rainha, enquanto 🦀 Artrópodes seguem no máximo Peão → Cavalo → Bispo; Rei permanece possível nos dois ramos. Linhagens fotossintéticas ficam restritas a Rei e Peão; ao adquirir Fotossíntese em uma forma derivada, a peça é convertida em Peão. Genes recessivos contam como descoberta quando o fenótipo é expresso.",
    "Mutações deletérias e perdas de características ficam fora do pool no 1º Ciclo da campanha e passam a poder ocorrer a partir do 2º Ciclo. Antes de 🩹 Reparo Celular, a chance de entrar no ramo de mutações negativas é o dobro da chance normal; ao expressar Reparo Celular, volta aos valores de referência do jogo.",
    "Surtos patogênicos podem assumir três agentes. ☀︎ Vírus Patógenos transmitem-se por contato entre criaturas; 🦠 Bactérias Patógenas permanecem nas casas abandonadas por hospedeiros infectados e podem contaminar quem atravessa ou permanece nesses rastros; 🍄 Fungos Patógenos contaminam casas, criam dois novos focos distantes por rodada e resolvem uma chance de mortalidade a cada rodada de exposição. Vetores, pressão populacional e eventos ecológicos podem iniciar qualquer um dos três agentes. Cada rodada de exposição oferece 1/2 de chance de alteração somática antes de 🩹 Reparo Celular e 1/4 depois dele, limitada a uma alteração negativa por surto; essas alterações ficam fora do genoma transmitido à prole.",
    "Na reprodução sexuada, escolha um aliado adjacente fértil e reprodutivamente apto. Normalmente, fotossintéticos só podem reproduzir sexualmente com fotossintéticos e predatórios apenas com predatórios. A exceção é ☯ Mixotrofia: dois indivíduos que a expressem podem reproduzir entre si mesmo quando seus ramos ancestrais são diferentes. O descendente herda um dos dois ramos ancestrais como identidade e recebe normalmente um alelo de Mixotrofia de cada progenitor, podendo ou não expressá-la conforme dominância e combinação alélica. Ambos os progenitores entram no mesmo período de recuperação reprodutiva.",
    "O desenvolvimento reprodutivo ocupa um único locus: imediato, 🥒 Ovíparo, 🦎 Ovíparos Amniotas, 🪳 Ovovivíparo ou 🔴 Vivíparo. A peça expressa apenas uma dessas modalidades por vez, embora alelos recessivos possam permanecer ocultos. Na reprodução sexuada, cada descendente recebe um alelo de cada progenitor em cada locus.",
    "🥒 Ovíparos depositam um ovo ⚪ móvel que busca terreno fértil; ele amadurece após três rodadas e se perde ao completar seis sem encontrar habitat adequado. 🦎 Ovíparos Amniotas surgem no Carbonífero: ao reproduzir, casas vazias a até três casas recebem indicação de postura; você escolhe onde colocar um 🥚, que eclode na rodada seguinte. 🪳 Ovovivíparos surgem opcionalmente no Permiano: carregam a prole por três rodadas; quando pronta, selecionar o progenitor mostra casas vazias adjacentes com ⚪ translúcidos, e a postura consome o turno e eclode na rodada seguinte. 🔴 Vivíparos carregam a ninhada por três rodadas e dão à luz diretamente. 🐍 Ovífagia permite capturar ovos inimigos; a ninhada consumida determina quantos descendentes o ovífago tenta gerar. 🐮 Lactação amadurece uma cria juvenil adjacente ao custo da ação do turno.",
    "Fotossíntese torna fértil uma casa neutra após três rodadas completas de permanência, desde que existam pelo menos duas casas adjacentes desocupadas. 🟢 Fotossíntese e 🐟 Predação continuam sendo ramos energéticos hereditários e mutuamente exclusivos: mutações comuns não convertem um ramo no outro e perdas genéticas não removem essa identidade. ☯ Mixotrofia surge opcionalmente no Triássico, requer Multicelularismo, Respiração aeróbia e um dos dois ramos, e é uma mutação diploide normal: pode ser dominante ou recessiva. Quando expressa, acrescenta a função energética básica do ramo oposto sem liberar suas especializações nem apagar a origem ancestral. Dois mixotróficos podem atravessar a barreira reprodutiva entre os ramos. Dormência imobiliza a criatura em casa hostil e evita o risco ambiental durante a permanência. Regeneração evita uma morte causada pelo ambiente uma vez por vida e força descanso na rodada seguinte.",
    "🐸 Respiração Cutânea surge opcionalmente no Devoniano após Locomoção Articulada. Uma criatura não fotossintética reprodutivamente apta pode permanecer onde está e consumir uma casa fértil ortogonalmente adjacente para reproduzir. Carnívoros puros não usam esse recurso; 🐻 Onívoro recupera essa possibilidade. 🦕 Sacos Aéreos surgem opcionalmente no Triássico após Locomoção Avançada e favorecem gigantismo: qualquer descendente que expresse Sacos Aéreos nasce no mínimo como Cavalo; a característica não depende de Voo.",
    ...
    "Linhagens com Fotossíntese não adquirem especializações animais como Simetria Bilateral, Locomoção Primitiva, Vertebrado, Artrópode, Locomoção Articulada, Percepção Espacial, Locomoção Avançada, Escavador, Escalador, Respiração Cutânea, Sacos Aéreos, Carnívoro, Canibalismo, Onívoro, Necrófago, Ovíparo, Ovíparos Amniotas, Ovovivíparo, Vivíparo, Ovulação Induzida, Ovífagia, Incubação, Lactação, Ooteca, Voo, Visão Noturna, Eusocialidade, Chifre, Construtor de Nicho, Polegar Opositor, Neocórtex Desenvolvido ou Antropização. Predação e Fotossíntese permanecem identidades de ramo separadas após a origem primordial; ☯ Mixotrofia fornece capacidades metabólicas complementares sem desbloquear automaticamente especializações do outro ramo. Reparo Celular, Dormência, Resistência, Regeneração, Reprodução Sexuada, Precocidade Sexual, Carapaça, Camuflagem, Veneno, Coletor e mutações negativas continuam compatíveis com plantas.",
    "🪱 Parasitismo surge opcionalmente no Cambriano no ramo não fotossintético. Selecione a peça e toque nela novamente para gastar a ação: sua casa se torna fértil e cada casa adjacente ocupada por um oponente se torna hostil. Incubação protege contra Ovífagia enquanto o progenitor estiver vivo e adjacente ao ovo. ꩜ Percepção Espacial habilita o alcance ofensivo remoto normal; Visão Binocular continua sendo a especialização que permite capturar Camuflagem à distância; Visão Noturna neutraliza a evasão de Notívagos em rodadas noturnas. Eusocialidade recebe até +2 descendentes de trabalhadores estéreis aparentados e adjacentes.",
    ...
    "🦗︎ Sociabilidade surge a partir do Jurássico em linhagens que já passaram por Incubação. Quando uma criatura pertence a um bloco conectado de quatro ou mais peças com Sociabilidade e é atacada, o defensor escolhe qualquer membro desse bloco para ser sacrificado e impedir a captura.",
