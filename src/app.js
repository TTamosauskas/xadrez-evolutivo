...
$("rules").addEventListener("click", () =>
  info("Como jogar", [
    "Antes do 1º Ciclo, um Rei ancestral cinza aparece em uma das quatro casas centrais. Selecione-o e toque nele novamente para separar o ancestral comum em um Rei branco e um Rei preto, posicionados de forma oposta e simétrica. Esses dois Reis fundam a 1ª Geração. A partir do 2º Ciclo da campanha, a dupla fundadora preserva duas histórias evolutivas sempre que possível: 🏆 a linhagem dominante do vencedor e 🟢 a linhagem fotossintética mais bem-sucedida da etapa anterior. A linhagem dominante permanece no lado vencedor e a contraparte ocupa o lado oposto.",
    "Cada partida completa é um Ciclo Evolutivo. Ao fim de uma Extinção em Massa, se a linhagem dominante não for fotossintética, ela forma a nova dupla com a linhagem 🟢 fotossintética de maior população; os empates usam a geração mais avançada e depois a assinatura evolutiva. Se a própria dominante já tiver Fotossíntese, a segunda vaga vai para a linhagem não fotossintética mais bem-sucedida. Se não existir uma contraparte distinta, a dominante continua fundando os dois lados como antes. No Arqueano, o 1º Ciclo oferece somente 🟢 Fotossíntese e depois 🐟 Predação; 🧫 Fertilidade e depois 💤 Dormência entram a partir do 2º Ciclo, após a primeira dupla ter surgido.",
    ...
    "Linhagens com Fotossíntese não adquirem especializações animais como Locomoção, Locomoção Avançada, Escalador, Respiração Cutânea, Sacos Aéreos, Carnívoro, Canibalismo, Onívoro, Necrófago, Ovíparo, Ovíparos Amniotas, Ovovivíparo, Vivíparo, Ovulação Induzida, Ovífagia, Cuidado Parental, Lactação, Ooteca, Voo, Visão Noturna, Eusocialidade, Chifre, Polegar Opositor, Neocórtex Desenvolvido ou Construtor Avançado. Predação continua sendo uma mutação de troca de ramo: ao surgir, remove Fotossíntese e suas especializações vegetais. Fertilidade, Dormência, Resistência, Regeneração, Reprodução Sexuada, Precocidade Sexual, Esporos, Construção de Nicho, Carapaça, Camuflagem, Veneno, Coletor e mutações negativas continuam compatíveis com plantas.",
    ...
    "O relevo natural também faz parte do tabuleiro: quadrados marrons surgem em pequenas cadeias ou afloramentos, com quantidade parcialmente aleatória e própria de cada período geológico. Eles evitam a vizinhança imediata dos fundadores e a geração rejeita configurações que fragmentem excessivamente o mapa. 🐐 Escalador surge opcionalmente no Devoniano após Locomoção e permite animais ocuparem e atravessarem barreiras naturais; 🐦 Voo pode atravessá-las, mas não pousar nelas. 🌿 Trepadeira surge opcionalmente no Carbonífero no ramo vegetal e usa tanto barreiras naturais quanto construídas como suporte vivo. Meteoros, vulcanismo, terremotos, mares, gelo, rios e chuvas podem criar, derrubar ou erodir parte desse relevo.",
    "⬡ Construção de Nicho neutraliza uma casa hostil estável quando a criatura termina ali e sobrevive. 🦫 Construtor Avançado, liberado no Neógeno após Construção de Nicho, pode erguer uma barreira marrom adjacente depois de uma reprodução bem-sucedida que consumiu uma casa fértil. Barreiras construídas bloqueiam o deslocamento animal: Voo pode atravessá-las sem destruí-las e Chifre as destrói ao atravessar. Chifre não destrói barreiras naturais; animais precisam de 🐐 Escalador para ocupá-las. 🌿 Trepadeira é a resposta vegetal: pode ocupar, fertilizar e reproduzir sobre barreiras naturais ou construídas sem removê-las. Polegar Opositor pode transferir o terreno fértil ou hostil de chegada para uma casa neutra adjacente; terrenos temporários de eventos, decomposição e barreiras não podem ser manipulados.",
