...
$("rules").addEventListener("click", () =>
  info("Como jogar", [
    "Antes do 1º Ciclo, um Rei ancestral cinza aparece em uma das quatro casas centrais. Selecione-o e toque nele novamente para separar o ancestral comum em um Rei branco e um Rei preto, posicionados de forma oposta e simétrica. Esses dois Reis fundam a 1ª Geração. A partir do 2º Ciclo, quando as duas ramificações existem, ambos os lados começam em igualdade com uma dupla formada pela linhagem dominante preservada e sua contraparte do outro ramo energético: uma fotossintética e uma não fotossintética em cada lado.",
    "Cada partida completa é um Ciclo Evolutivo. Ao fim de uma Extinção em Massa, a linhagem dominante do vencedor é preservada e a melhor contraparte do ramo energético oposto é selecionada. Quando ambas existem, as duas são duplicadas simetricamente: Brancas e Pretas recebem uma representante fotossintética e uma não fotossintética. Se uma das ramificações desapareceu completamente, a linhagem disponível continua fundando os dois lados como antes. No Arqueano, o 1º Ciclo oferece somente 🟢 Fotossíntese e depois 🐟 Predação; 🧫 Fertilidade e depois 💤 Dormência entram a partir do 2º Ciclo, após a primeira dupla ter surgido.",
    ...
    "🪱 Parasitismo surge opcionalmente no Cambriano no ramo não fotossintético. Selecione a peça e toque nela novamente para gastar a ação: sua casa se torna fértil e cada casa adjacente ocupada por um oponente se torna hostil. Cuidado Parental protege contra Ovífagia enquanto o progenitor estiver vivo e adjacente ao ovo. Visão Noturna permite capturar Camuflagem à distância. Eusocialidade recebe até +2 descendentes de trabalhadores estéreis aparentados e adjacentes.",
