...
$("rules").addEventListener("click", () =>
  info("Como jogar", [
    ...
    "🐟 Predação é uma mutação basal do Arqueano. Antes da Locomoção Articulada Articulada, ela permite apenas capturas que já pertencem à geometria tradicional da peça: Reis capturam uma casa em qualquer direção e Peões apenas nas diagonais de captura. 🦵 Locomoção Articulada Articulada libera deslocamentos para casas vazias e pode surgir em descendentes de uma linhagem que já expressou Predação. 🐎 Locomoção Avançada permite a segunda movimentação do turno. 🦁 Carnívoro também descende de Predação, reproduz ao capturar e abandona o uso de casas férteis; 🦈 Canibalismo surge no Cambriano após Carnívoro e permite capturar aliados quando o agressor está apto a se reproduzir, convertendo a morte em exatamente um descendente; 🐻 Onívoro surge depois de Carnívoro e recupera também o uso de recursos férteis.",
    ...
    "Linhagens com Fotossíntese não adquirem especializações animais como Locomoção Articulada Articulada, Locomoção Avançada, Escavador, Escalador, Respiração Cutânea, Sacos Aéreos, Carnívoro, Canibalismo, Onívoro, Necrófago, Ovíparo, Ovíparos Amniotas, Ovovivíparo, Vivíparo, Ovulação Induzida, Ovífagia, Cuidado Parental, Lactação, Ooteca, Voo, Visão Noturna, Eusocialidade, Chifre, Construtor de Nicho, Polegar Opositor, Neocórtex Desenvolvido ou Antropização. Predação continua sendo uma mutação de troca de ramo: ao surgir, remove Fotossíntese e suas especializações vegetais. Dormência, Resistência, Regeneração, Reprodução Sexuada, Precocidade Sexual, Esporos, Carapaça, Camuflagem, Veneno, Coletor e mutações negativas continuam compatíveis com plantas.",
