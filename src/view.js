  ...
  for (let r = 0; r < 8; r++)
    for (let c = 0; c < 8; c++) {
      const p = at(state, r, c),
        ...
        vivificationTarget =
          reproductionTarget || selfVivificationTarget || originHere,
      ...
      const eggLabel = egg
        ...
        plantSeedLabel = plantSeed
          ...
          : "",
        label = originHere
          ? `${coord(r, c)}, Rei ancestral cinza, Vivificar disponível${origin?.selected ? "; selecionado; toque novamente para iniciar" : "; selecione para iniciar"}`
