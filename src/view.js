  ...
  const legend = $("board-legend"),
    legendEntries = [
      ...
      boardElement.querySelector(
        ...
        : null,
      boardElement.querySelector(".cell.attack-target")
        ? {
            label: "Ataque",
