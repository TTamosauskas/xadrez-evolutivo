...
export function howToPlayLines() {
  ...
  return [
    ...
    section("Grupos de comparação do Legado Genético"),
    "O Legado Genético também reúne características que já se estabeleceram no grupo biológico em que fazem sentido. Enquanto uma característica estiver presente em todos os organismos do seu grupo de comparação, ela continua ativa mecanicamente e deixa de ocupar a moldura e as listas diferenciais.",
    "Características compartilhadas entre grandes ramos são comparadas na população viva inteira. Características próprias do ramo vegetal são comparadas entre organismos fotossintéticos. Características incompatíveis com plantas, como Simetria Bilateral, são comparadas entre organismos não fotossintéticos.",
    "Fotossíntese e Predação formam os ramos energéticos basais. Enquanto toda peça viva pertencer a pelo menos um desses ramos, o ramo energético de cada organismo fica em Legado Genético. Se surgir uma peça que não expresse Fotossíntese nem Predação, os dois ramos voltam a ser informação diferencial.",
    "Para características derivadas de um ramo, o estabelecimento exige pelo menos dois organismos no grupo de comparação. Quando surgir dentro desse grupo um organismo sem a característica, ela retorna automaticamente às Vantagens Evolutivas ou Desvantagens Evolutivas das peças que a expressam.",
    ...
    "No tabuleiro, apenas características fenotípicas diferenciais formam a moldura de até 12 ícones ao redor da peça. Uma característica hereditária estabelecida em todo o seu grupo evolutivo de comparação continua produzindo seus efeitos, sai das molduras e das listas diferenciais e aparece em Legado Genético; se surgir nesse grupo um organismo sem ela, retorna automaticamente à exibição individual. Características vegetais são comparadas entre fotossintéticos, características incompatíveis com plantas entre não fotossintéticos e características compartilhadas na população inteira. Fotossíntese e Predação funcionam como ramos energéticos basais: permanecem no Legado enquanto toda peça viva pertence a pelo menos um desses ramos e voltam à exibição individual se surgir uma peça sem nenhum deles. Vantagens e desvantagens diferenciais ficam separadas no painel; Genes Recessivos permanecem ocultos no fenótipo, e mutações somáticas continuam sempre visíveis como alterações individuais.",
