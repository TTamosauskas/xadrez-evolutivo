...
export function howToPlayLines() {
  ...
  return [
    ...
    "🟩 Casas férteis são o principal recurso reprodutivo. 🟥 Casas hostis oferecem 50% de risco ambiental por exposição normal; capturas sem reprodução também deixam uma perturbação vermelha curta. 💩 Matéria orgânica permanece por três rodadas após capturas que efetivamente geram descendência: fotossintéticos e mixotróficos a reciclam automaticamente em fertilidade, enquanto Necrófagos e Onívoros Oportunistas podem consumi-la para reproduzir. ☠️ marca ambiente letal: entrar ou pousar causa morte certa. 🟫 Barreiras bloqueiam trajetórias salvo adaptações específicas.",
    ...
    `Após ${traitLabel("Multicelularismo")}, ${traitLabel("Carnívoro")} permite reprodução predatória ao capturar criaturas não fotossintéticas, ${traitLabel("Herbívoro")} faz o mesmo com criaturas fotossintéticas e ${traitLabel("Onívoro")} reúne ambos os espectros alimentares. Essas dietas não alteram o acesso à reprodução basal em fertilidade. Capturas que geram descendência deixam 💩 matéria orgânica; capturas sem reprodução deixam apenas perturbação hostil curta. ${traitLabel("Canibalismo")} converte uma captura aliada em um descendente, e ${traitLabel("Necrófago")} usa 💩 como recurso.`,
