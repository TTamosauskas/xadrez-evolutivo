...
export function howToPlayLines() {
  ...
  return [
    ...
    `No ciclo seguinte à primeira descoberta de ${traitLabel("Reprodução Sexuada")}, surtos ecológicos também podem assumir uma rota viral sexual: a transmissão ocorre apenas durante acasalamento e não por mera proximidade. A partir do Siluriano, surtos bacterianos também podem assumir rota fecal: hospedeiros infectados contaminam 💩 produzidas por reprodução trófica; tocar o resíduo pode transmitir e ${traitLabel("Coprofagia")} implica ingestão direta. Fezes continuam visualmente iguais e perdem a contaminação quando são consumidas, recicladas ou expiram.`,
