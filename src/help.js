...
export function howToPlayLines() {
  ...
  return [
    ...
    `${traitLabel("Locomoção Terrestre")} remove a dependência de casas férteis para terminar movimentos a partir do Siluriano. ${traitLabel("Escavador")}, ${traitLabel("Escalador")} e ${traitLabel("Voo")} interagem de formas diferentes com barreiras.`,
