...
export function howToPlayLines() {
  ...
  return [
    ...
    "Vida na Terra: campanha histórica. O Hadeano funciona como prólogo tutorial hipotético: um único Rei cinza representa o ancestral comum no núcleo fértil 4×4 cercado por ☠️. Ao ser selecionado e ativado, ele se divide em um Rei branco e um Rei preto, ambos protocelulares, sem mutações e ainda sem 🟢 Fotossíntese ou 👾 Predação. A partir deles, o jogador aprende deslocamento ancestral, divisão basal e captura; esses três fundamentos são apenas objetivos pedagógicos e não encerram o período. Como nas demais fases, o Hadeano termina quando um dos lados é extinto. Então começa o Arqueano · 1º Ciclo e surgem as linhagens energéticas 🟢 fotossintética e 👾 predatória.",
