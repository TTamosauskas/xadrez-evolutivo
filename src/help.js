...
export function howToPlayLines() {
  ...
  return [
    ...
    section("Hadeano"),
    "O Hadeano é o prólogo da campanha Vida na Terra. Um único Rei cinza representa o ancestral comum e já começa com a primeira inovação metabólica — ⚪ Respiração anaeróbia — visível em Vantagens Evolutivas. Ao ser ativado novamente, o ancestral se divide em um Rei branco e um Rei preto que herdam esse metabolismo e podem consumir casas férteis para sustentar a divisão basal. O núcleo 4×4 é fértil, mas as duas camadas externas ☠️ continuam fazendo parte do tabuleiro: podem ser ocupadas e são letais, ensinando a hostilidade ambiental pela consequência.",
    "Respiração anaeróbia é a única mutação fundadora do Hadeano e já pertence ao ancestral comum quando o jogador assume o controle; outras mutações aleatórias ficam fechadas nesse período. Deslocar, dividir e capturar são objetivos pedagógicos, mas não encerram a fase. Como nos demais períodos, o Hadeano termina apenas quando um dos lados é extinto; então ocorre a transição formal para Arqueano · 1º Ciclo, que herda Respiração anaeróbia.",
