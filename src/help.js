...
function earthTimelineLines() {
  return GEOLOGICAL_STAGES.map((stage) => {
    ...
    if (stage.id === "archean")
      return `${stage.group} · ${stage.period}: 1º Ciclo — herda Respiração anaeróbia e abre Fotossíntese / Predação; 2º Ciclo — Reparo Celular; 3º Ciclo — Dormência`;
